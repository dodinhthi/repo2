...
public class BankServiceServiceLocator extends org.apache.axis.client.Service implements nhatnghe.jws.BankServiceService {
    ...
    private java.lang.String BankService_address = "http://localhost:9090/eBank357/services/BankService";
    ...
    public nhatnghe.jws.BankService getBankService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            nhatnghe.jws.BankServiceSoapBindingStub _stub = new nhatnghe.jws.BankServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (nhatnghe.jws.BankService.class.isAssignableFrom(serviceEndpointInterface)) {
                nhatnghe.jws.BankServiceSoapBindingStub _stub = new nhatnghe.jws.BankServiceSoapBindingStub(new java.net.URL(BankService_address), this);
                _stub.setPortName(getBankServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://jws.nhatnghe", "BankServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://jws.nhatnghe", "BankService"));
        }
